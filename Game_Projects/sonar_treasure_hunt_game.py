...
def getNewBoard():
    ...
    for x in range(60): # The main list is a list of 60 lists.
        ...
        for y in range(15): # Each list in the main list has 15 single-character strings.
            # We use different characters for the ocean to make it more readable.
...
def showInstructions():
    print('''       You are the captain of the Black Pearl, a treasure-hunting ship. Your current
    ...
    print('''           When you drop a sonar device directly on a chest, you
           retrieve it and the other sonar devices update to show how far away
           the next nearest chest is. The chests are beyond the range
           of the sonar device on the left, so it shows an X.
